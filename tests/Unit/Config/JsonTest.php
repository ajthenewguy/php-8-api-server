...
use Ajthenewguy\Php8ApiServer\Config\JsonPointer;
...
final class JsonTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        JsonConfig::sees(\Ajthenewguy\Php8ApiServer\Config\Json::class);
    }
    ...
    public function testResolveRefConfigFile()
    {
        ...
        $this->assertInstanceOf(\Ajthenewguy\Php8ApiServer\Config\Json::class, $refConfig);
