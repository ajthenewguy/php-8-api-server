...
use Ajthenewguy\Php8ApiServer\Exceptions\InvalidFileModeException;
...
final class FileTest extends TestCase
{
    ...
    {
        $this->expectException(\Ajthenewguy\Php8ApiServer\Exceptions\FileNotFoundException::class);
